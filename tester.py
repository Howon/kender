...
def main():
    ...
    while True:
        ...
        for rect in rects:
            ...
            put_text(frame, "      Total", (230, 20))
            put_text(frame, "     blinks: " + str(total_blinks), (230, 40))
            put_text(frame, " left winks: " + str(total_left_winks), (230, 55))
            put_text(frame, "right winks: " + str(total_right_winks), (230, 70))
            put_text(frame, "       left: " + str(total_left), (230, 85))
            put_text(frame, "      right: " + str(total_right), (230, 100))
            put_text(frame, "         up: " + str(total_up), (230, 115))
            put_text(frame, "       down: " + str(total_down), (230, 130))
            put_text(frame, "      zoomed: " + str(total_zoomed), (230, 145))
