...
success = {
    ...
    HeadAction.LEFT: ([HeadAction.CENTER, HeadAction.DOWN, HeadAction.ZOOM], HeadAction.LEFT),
    HeadAction.RIGHT: ([HeadAction.CENTER, HeadAction.DOWN, HeadAction.ZOOM], HeadAction.RIGHT),
